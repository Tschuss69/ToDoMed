...
export const List: FunctionComponent<Props> = ({ contactpoints }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">ContactPoint List</h1>
      <Link
        href="/contactpoints/create"
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {contactpoints &&
          ...
          contactpoints.map(
            (contactpoint) =>
              contactpoint["@id"] && (
                <tr className="py-2" key={contactpoint["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(
