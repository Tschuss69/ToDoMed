...
export const List: FunctionComponent<Props> = ({ encounters }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">Encounter List</h1>
      <Link
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {encounters &&
          ...
          encounters.map(
            (encounter) =>
              encounter["@id"] && (
                <tr className="py-2" key={encounter["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(encounter["@id"], "/encounters/[id]"),
                        name: encounter["@id"],
                      }}
                    />
                  </th>
