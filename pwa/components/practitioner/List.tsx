...
export const List: FunctionComponent<Props> = ({ practitioners }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">Practitioner List</h1>
      <Link
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {practitioners &&
          ...
          practitioners.map(
            (practitioner) =>
              practitioner["@id"] && (
                <tr className="py-2" key={practitioner["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(
                  ...
                  <td>
                    <ReferenceLinks
                      items={practitioner["practitionerRoles"].map(
                        (ref: any) => ({
