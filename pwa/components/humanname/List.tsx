...
export const List: FunctionComponent<Props> = ({ humannames }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">HumanName List</h1>
      <Link
        href="/humannames/create"
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {humannames &&
          ...
          humannames.map(
            (humanname) =>
              humanname["@id"] && (
                <tr className="py-2" key={humanname["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(humanname["@id"], "/humannames/[id]"),
                        name: humanname["@id"],
                      }}
                    />
                  </th>
